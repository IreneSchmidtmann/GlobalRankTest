...
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}
\includegraphics[width=7cm,height=7cm]{figure/powerplot2-1} 

\includegraphics[width=7cm,height=7cm]{figure/powerplot2-2} 

\includegraphics[width=7cm,height=7cm]{figure/powerplot2-3} 

\includegraphics[width=7cm,height=7cm]{figure/powerplot2-4} 
