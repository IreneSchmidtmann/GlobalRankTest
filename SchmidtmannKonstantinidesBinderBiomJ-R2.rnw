...
\begin{document}
% 2nd revision of paper submitted to Biometrical Journal
...
# This chunk produces table 2 in the paper
...
of the estimated power is \Sexpr{sqrt(0.8 * 0.2 / r)}, i. e.
\Sexpr{100* sqrt(0.8 * 0.2 / r)} percentage points. This supports the conclusion
...
# This chunk produces table 3 in the paper
