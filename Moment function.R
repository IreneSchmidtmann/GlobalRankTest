...
for (p in chosen_ps) {
  ...
  MyPower <- power_gr(alpha = 0.0294, 
                      p_0_0 = p, p_1_0 = p, p_0_1 = p, p_1_1 = p, 
   ...
   print(MyPower.Matrix[, as.character(p)])
}
