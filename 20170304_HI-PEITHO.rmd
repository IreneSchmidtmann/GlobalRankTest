...
Let $X_{0k} \sim \mathcal{N}(\mu_0, \sigma^2)$, $X_{1l} \sim \mathcal{N}(\mu_1, \sigma^2)$ and $\delta = \mu_1 - \mu_0$.

Hence $Y_{0k}:=\frac{X_{0k} - \mu_0}{\sigma} \sim \mathcal{N}(0, 1)$ and $Y_{1l}:=\frac{X_{1l} - \mu_0}{\sigma} = \frac{X_{il} - \mu_1 + \delta}{\sigma} \sim \mathcal{N}( \frac{\delta}{\sigma}, 1)$
