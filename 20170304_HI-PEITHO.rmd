...
& = & \int_{-\infty}^{\infty}\varphi(x - \frac{\delta}{\sigma}) \Phi(x) dx - \Big( \Phi^2(x - \frac{\delta}{\sigma})\Phi(x)|_{-\infty}^{\infty} - \int_{-\infty}^{\infty} \Phi^2(x - \frac{\delta}{\sigma}) \varphi(x) dx\Big)\\
