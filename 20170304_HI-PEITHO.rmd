...
= \frac{1}{p_0 p_1}\left( p_0 p_1 - p_0 - \frac{1}{1 + \mathit{HR}} ( p_0 p_1  - p_0 - p_1)\right) \\
& = & \frac{1}{p_0 p_1}\left(p_0 (p_1 - 1)(1-\frac{1}{1+\mathit{HR}}) + \frac{1}{1+\mathit{HR}} p_1 \right) \\
...
& = & \int_{-\infty}^{\infty}\varphi(x - \frac{\delta}{\sigma}) \Phi(x) dx - \left( \Phi^2(y - \frac{\delta}{\sigma})\Phi(x)|_{-\infty}^{\infty} - \int_{-\infty}^{\infty} \Phi^2(y - \frac{\delta}{\sigma}) \phi(x) dx\right)\\
