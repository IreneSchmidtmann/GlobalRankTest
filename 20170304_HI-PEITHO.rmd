...
& = & \frac{1}{p_0^2 p_1}\Big(p_1 + \frac{2\lambda_1}{\lambda_0 + \lambda_1} (e^{-(\lambda_0 + \lambda1)\tau} - 1) \\
&   & - \frac{\lambda_1}{2\lambda_0 + \lambda_1} (e^{-(2\lambda_0 + \lambda1)\tau} - 1) \Big) \\
& = & \frac{1}{p_0^2 p_1}\Big(p_1 + \frac{2\lambda_1}{\lambda_0 + \lambda_1} (q_0 q_1 - 1) - \frac{\lambda_1}{2\lambda_0 + \lambda_1}(q_0^2 q_1 - 1) \Big) \\
& = & \frac{1}{p_0^2 p_1}\Big(p_1 + \frac{2}{1 + \mathit{HR}} (q_0 q_1 - 1) - \frac{1}{2 + \mathit{HR}}(q_0^2 q_1 - 1) \Big) \\
\\
...
\begin{eqnarray*}
\pi_{x1} & = & P(X_{0k} < X_{1l}) = P(Y_{0k} < Y_{1l}) \\
...
& = & \int_{-\infty}^{\infty}\varphi(x - \frac{\delta}{\sigma}) \Phi(x) dx - \Big( \Phi^2(y - \frac{\delta}{\sigma})\Phi(x)|_{-\infty}^{\infty} - \int_{-\infty}^{\infty} \Phi^2(y - \frac{\delta}{\sigma}) \phi(x) dx\Big)\\
& = & 2\pi_{x1} - 1 + \int_{-\infty}^{\infty} \Phi^2(y - \frac{\delta}{\sigma}) \phi(x) dx \\
\\
\end{eqnarray*}
